...
// actually finishing, not a fake timer.
const CRITICAL_ASSETS = ["/bg.jpg", "/earth.png"];
const MIN_VISIBLE_MS = 900;
const EXIT_DURATION_MS = 700;
const RADIUS = 26;
const CIRCUMFERENCE = 2 * Math.PI * RADIUS;
const ACCENT = "#7dd3fc"; // matches --accent in globals.css
...
export default function PageLoader() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-busy={!ready}
      className={`fixed inset-0 z-100 flex flex-col items-center justify-center bg-cover bg-center transition-[opacity,transform,filter] ease-out ${
        ready
