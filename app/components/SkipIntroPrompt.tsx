      ...
      <AnimatePresence>
        {shown && (
          <motion.div
            ...
            className="pointer-events-auto flex items-center gap-2.5 rounded-full border border-white/15 bg-slate-950/85 py-1.5 pl-4 pr-1.5 text-sky-50 shadow-[0_16px_40px_rgba(2,8,23,0.55)] "
          >
