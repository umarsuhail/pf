...
export function GlassPanel({
  ...
  return (
    <div
      className={`group relative rounded-2xl border border-white/15 bg-white/5 shadow-lg shadow-black/10 backdrop-blur-xl transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-white/25 hover:shadow-[0_0_50px_-12px_var(--accent)] ${className}`}
    >
